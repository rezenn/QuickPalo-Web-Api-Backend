// // controllers/organization-details.controller.ts
...
//       const parsedData = CreateOrganizationDetailsDto.safeParse(req.body);
...
//       const organization = await organizationDetailsService.createOrganizationDetails(
//         userId.toString(),
//         parsedData.data
//       );
...
//       const organization = await organizationDetailsService.getOrganizationByUserId(
//         userId.toString()
//       );
